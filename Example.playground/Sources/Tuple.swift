...
public struct Tuple {
    ...
    static public func order<T1, T2>(of tuple: (T1, T2)) -> Int {
        return 2
    }

    static public func order<T1, T2, T3>(of tuple: (T1, T2, T3)) -> Int {
        return 3
    }

    static public func order<T1, T2, T3, T4>(of tuple: (T1, T2, T3, T4)) -> Int {
        return 4
    }

    static public func order<T1, T2, T3, T4, T5>(of tuple: (T1, T2, T3, T4, T5)) -> Int {
        return 5
    }

    static public func order<T1, T2, T3, T4, T5, T6>(of tuple: (T1, T2, T3, T4, T5, T6)) -> Int {
        return 6
    }

    static public func order<T1, T2, T3, T4, T5, T6, T7>(of tuple: (T1, T2, T3, T4, T5, T6, T7)) -> Int {
        return 7
    }

    static public func order<T1, T2, T3, T4, T5, T6, T7, T8>(of tuple: (T1, T2, T3, T4, T5, T6, T7, T8)) -> Int {
        return 8
    }
    ...
    static public func element<T1, Element>(at index: Int, in tuple: T1) -> Element? {
        switch index {
            case 0: return tuple as? Element
        default:
            return nil
        }
    }

    static public func element<T1, T2, Element>(at index: Int, in tuple: (T1, T2)) -> Element? {
        switch index {
            case 0: return tuple.0 as? Element
            case 1: return tuple.1 as? Element
        default:
            return nil
        }
    }

    static public func element<T1, T2, T3, Element>(at index: Int, in tuple: (T1, T2, T3)) -> Element? {
        switch index {
            case 0: return tuple.0 as? Element
            case 1: return tuple.1 as? Element
            case 2: return tuple.2 as? Element
        default:
            return nil
        }
    }

    static public func element<T1, T2, T3, T4, Element>(at index: Int, in tuple: (T1, T2, T3, T4)) -> Element? {
        switch index {
            case 0: return tuple.0 as? Element
            case 1: return tuple.1 as? Element
            case 2: return tuple.2 as? Element
            case 3: return tuple.3 as? Element
        default:
            return nil
        }
    }

    static public func element<T1, T2, T3, T4, T5, Element>(at index: Int, in tuple: (T1, T2, T3, T4, T5)) -> Element? {
        switch index {
            case 0: return tuple.0 as? Element
            case 1: return tuple.1 as? Element
            case 2: return tuple.2 as? Element
            case 3: return tuple.3 as? Element
            case 4: return tuple.4 as? Element
        default:
            return nil
        }
    }

    static public func element<T1, T2, T3, T4, T5, T6, Element>(at index: Int, in tuple: (T1, T2, T3, T4, T5, T6)) -> Element? {
        switch index {
            case 0: return tuple.0 as? Element
            case 1: return tuple.1 as? Element
            case 2: return tuple.2 as? Element
            case 3: return tuple.3 as? Element
            case 4: return tuple.4 as? Element
            case 5: return tuple.5 as? Element
        default:
            return nil
        }
    }

    static public func element<T1, T2, T3, T4, T5, T6, T7, Element>(at index: Int, in tuple: (T1, T2, T3, T4, T5, T6, T7)) -> Element? {
        switch index {
            case 0: return tuple.0 as? Element
            case 1: return tuple.1 as? Element
            case 2: return tuple.2 as? Element
            ...
            case 4: return tuple.4 as? Element
            case 5: return tuple.5 as? Element
            case 6: return tuple.6 as? Element
        default:
            return nil
        }
    }

    static public func element<T1, T2, T3, T4, T5, T6, T7, T8, Element>(at index: Int, in tuple: (T1, T2, T3, T4, T5, T6, T7, T8)) -> Element? {
        switch index {
            case 0: return tuple.0 as? Element
            case 1: return tuple.1 as? Element
            case 2: return tuple.2 as? Element
            ...
            case 5: return tuple.5 as? Element
            case 6: return tuple.6 as? Element
            case 7: return tuple.7 as? Element
        default:
            return nil
        }
    }
